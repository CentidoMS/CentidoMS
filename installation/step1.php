    ...
    <div id="wrap">
        ...
        <div class="navbar-inner">
          <div class="container">
            ...
            <div class="nav-collapse collapse">
				<ul class="nav">
					<li class="active"><a><?php getlang("LANG_INSTALLATION_GENERAL_STEP"); ?> 1</a></li>
      ...
      <div class="container">
        <div class="page-header">
          <h1><?php getlang("LANG_INSTALLATION_GENERAL_STEP"); ?> 1 - Choose a language</h1>
        </div>
        <p class="lead">
			Choose a language / Wählen sie eine Sprache aus
		</p>
        <p>
			<form method="POST" action="<?php echo $urlroot ?>index.php?step=1&action=1">
				<label class="select">Language / Sprache</label>
